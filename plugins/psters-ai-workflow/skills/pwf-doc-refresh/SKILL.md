...
description: >
  ...
  Use when: user wants to prevent docs/solutions/ from drifting or becoming stale.
argument-hint: "[optional: category or path under docs/solutions/]"
---

# Refresh Documentation Knowledge (Interactive)

Use this skill to prevent `docs/solutions/` from drifting or becoming stale.
...
Report: docs reviewed, actions approved/applied, docs skipped/deferred, follow-up suggestions.
