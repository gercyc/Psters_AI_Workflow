...
description: >
  ...
  Use when: user wants to document operational procedures for a service or critical workflow.
argument-hint: "[service/operation name or 'index']"
---

# Build Operational Runbooks

Use this skill to create or update operational runbooks for services and critical workflows.
...
If empty, ask: "Which runbook should I create or update? (example: `payments-api` or `deploy-backend`)"

Special target: `index` -> refresh `docs/runbooks/README.md`
...
3. Read related source docs before writing:
   - `docs/infrastructure.md`, `docs/architecture.md`, `docs/integrations.md`, `docs/environments.md`
...
Report: runbook path created/updated, index updates, missing operational data still needed from the user.
